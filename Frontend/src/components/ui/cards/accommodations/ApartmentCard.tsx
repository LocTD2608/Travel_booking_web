            ...
            <div className="flex-1 p-5 flex flex-col justify-between">
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-purple-700 font-semibold text-sm">{translateRating(apartment.ratingText)}</span>
                        <span className="text-gray-400 text-sm">({apartment.reviews} {t('search.reviewsCount', 'reviews')})</span>
                    </div>
                </div>
                <div className="flex justify-between items-end mt-4 gap-8">
                    <div className="flex flex-wrap gap-2">
                        {apartment.facilities.map(fac => {
                            ...
                            return (
                                <div key={fac} className="flex items-center gap-1 text-xs text-gray-500 bg-gray-50 border border-gray-200 px-3 py-1 rounded-full whitespace-nowrap">
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-xs text-gray-400 mb-3">/ {t('detail.nightUnit', 'night')}</div>
