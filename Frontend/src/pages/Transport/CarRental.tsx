...
import { CarCard } from '../../components/ui/cards/transport/CarCard';
            ...
            <div className="bg-white border-b border-gray-200 py-4 mb-6 sticky z-30 flex justify-center shadow-sm" style={{ top: '64px' }}>
                <div className="w-full max-w-[1200px] px-4 flex items-center justify-between">
                    <div className="flex gap-10">
                        <div>
                            <div className="text-xs text-gray-500 font-bold mb-0.5 tracking-wider">{t('header.carRental', 'Car Rental').toUpperCase()}</div>
            ...
            <div className="max-w-[1200px] mx-auto px-4 flex gap-6">
                <div className="w-[280px] flex-shrink-0">
                    <div className="bg-white border border-gray-200 rounded-xl p-5 mb-4 shadow-sm">
                        ...
                        <div className="mb-6">
                            <h4 className="font-semibold text-[15px] mb-4">{t('transport.priceDay', 'Price / Day')}</h4>
